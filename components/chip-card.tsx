    ...
    <article className="group flex h-full flex-col rounded-[24px] border border-white/8 bg-card/72 p-4 backdrop-blur transition duration-200 hover:-translate-y-0.5 hover:border-white/15 hover:bg-card">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex gap-1.5">
          <span className="rounded-full border border-white/10 px-2 py-1 font-mono text-[9px] text-muted-foreground">
            {chip.category}
          </span>
          <span className="rounded-full border border-white/10 px-2 py-1 font-mono text-[9px] text-muted-foreground">
            {chip.year}
      ...
      <dl className="mt-5 grid grid-cols-2 gap-2">
        <div className="rounded-2xl bg-white/[0.04] p-3">
          ...
          <dd className="mt-1.5 text-xs font-medium leading-5">
            {chip.memory}
          </dd>
        </div>
        <div className="rounded-2xl bg-white/[0.04] p-3">
